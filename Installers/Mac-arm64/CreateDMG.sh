...
cd ../../Release/Mac-arm64/TreeViewer.app/Contents/MacOS/
...
hdiutil create -srcfolder Release/Mac-arm64 -volname "TreeViewer" -fs HFS+ -format UDRW -size 350m "TreeViewer.rw.dmg"
